...
func disciplinePage(discipline *models.Discipline) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 18, Col: 64}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 26, Col: 33}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 27, Col: 64}
		}
		...
		if len(discipline.Labs) > 0 {
			...
			for _, lab := range discipline.Labs {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 58, Col: 50}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 1, Col: 0}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 60, Col: 75}
				}
				...
				if lab.Description != "" {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 65, Col: 84}
					}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 71, Col: 62}
				}
				...
				if lab.Deadline.Before(time.Now()) {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 80, Col: 99}
					}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 89, Col: 104}
				}
				...
				if status == "" {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 95, Col: 121}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 100, Col: 121}
					}
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 105, Col: 121}
					}
				...
				if status == "graded" {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 115, Col: 46}
					}
					...
					if studentReport.TeacherNote != "" {
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 119, Col: 70}
						}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 159, Col: 86}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 163, Col: 89}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 166, Col: 70}
		}
...
func olddisciplinePage(discipline *models.Discipline, reports map[string][]models.LabReport) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 180, Col: 54}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 188, Col: 23}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 189, Col: 54}
		}
		...
		if len(discipline.Labs) > 0 {
			...
			for _, lab := range discipline.Labs {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 209, Col: 16}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 211, Col: 47}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 215, Col: 74}
				}
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 219, Col: 87}
				}
				...
				if lab.Deadline.Before(time.Now()) {
					...
					if templ_7745c5c3_Err != nil {
						return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 229, Col: 47}
					}
				...
				if len(reports[lab.ID]) > 0 {
					...
					for _, rep := range reports[lab.ID] {
						...
						if templ_7745c5c3_Err != nil {
							return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 239, Col: 55}
						}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 265, Col: 66}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 266, Col: 68}
		}
...
func UploadModal(lab models.Lab, discipline string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 275, Col: 52}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 280, Col: 69}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 286, Col: 53}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `old/views/discipline.templ`, Line: 287, Col: 61}
		}
